      ...
      <div className="text-sm">
        ...
        <p>
          {customerInfo?.address?.city && customerInfo?.address?.state
            ? `${customerInfo.address.city}, ${customerInfo.address.state} ${customerInfo?.address.zip_code || ""}`
            : "No address provided"}
        </p>
      </div>
      ...
      <div className="text-sm">
        ...
        <p>
          {shippingAddress?.address?.city && shippingAddress?.address?.state
            ? `${shippingAddress.address.city}, ${shippingAddress.address.state} ${shippingAddress?.address.zip_code || ""}`
            : "No address provided"}
        </p>
      </div>
    </div>

...
export function LocationMap({ locations }: LocationMapProps) {
  ...
  const mapboxToken = 'pk.eyJ1IjoibG92YWJsZSIsImEiOiJja2VpbDE4b2UwbzJvMnJvNmV5ZDlhZGl4In0.Zv4Hh1TwQsYT1K0NhPGhJw';
  ...
  useEffect(() => {
    ...
    try {
      ...
      locations.forEach(location => {
        ...
        el.className = 'marker';
        el.style.backgroundColor = location.status === 'active' ? '#22c55e' : '#ef4444';
        el.style.width = '24px';
